...
export interface LiquidGlassOptions extends GlassOptions {}
...
export interface LiquidGlassHandle {
    ...
    on<K extends keyof LiquidGlassEventMap>(event: K, fn: (payload: LiquidGlassEventMap[K]) => void): this;
    off<K extends keyof LiquidGlassEventMap>(event: K, fn?: (payload: LiquidGlassEventMap[K]) => void): this;
    once<K extends keyof LiquidGlassEventMap>(event: K, fn: (payload: LiquidGlassEventMap[K]) => void): this;
...
export interface LiquidButtonHandle {
    readonly element: Element;
    on<K extends keyof LiquidButtonEventMap>(event: K, fn: (payload: LiquidButtonEventMap[K]) => void): this;
    off<K extends keyof LiquidButtonEventMap>(event: K, fn?: (payload: LiquidButtonEventMap[K]) => void): this;
    once<K extends keyof LiquidButtonEventMap>(event: K, fn: (payload: LiquidButtonEventMap[K]) => void): this;
...
export interface LiquidSwitchHandle {
    readonly element: Element;
    on<K extends keyof LiquidSwitchEventMap>(event: K, fn: (payload: LiquidSwitchEventMap[K]) => void): this;
    off<K extends keyof LiquidSwitchEventMap>(event: K, fn?: (payload: LiquidSwitchEventMap[K]) => void): this;
    once<K extends keyof LiquidSwitchEventMap>(event: K, fn: (payload: LiquidSwitchEventMap[K]) => void): this;
    checked: boolean;
    toggle(): this;
    destroy(): void;
}
...
export interface LiquidSliderHandle {
    readonly element: Element;
    on<K extends keyof LiquidSliderEventMap>(event: K, fn: (payload: LiquidSliderEventMap[K]) => void): this;
    off<K extends keyof LiquidSliderEventMap>(event: K, fn?: (payload: LiquidSliderEventMap[K]) => void): this;
    once<K extends keyof LiquidSliderEventMap>(event: K, fn: (payload: LiquidSliderEventMap[K]) => void): this;
    value: number;
    destroy(): void;
}
...
export interface LiquidCursorHandle {
    readonly element: Element;
    on<K extends keyof LiquidCursorEventMap>(event: K, fn: (payload: LiquidCursorEventMap[K]) => void): this;
    off<K extends keyof LiquidCursorEventMap>(event: K, fn?: (payload: LiquidCursorEventMap[K]) => void): this;
    once<K extends keyof LiquidCursorEventMap>(event: K, fn: (payload: LiquidCursorEventMap[K]) => void): this;
    destroy(): void;
}
...
export interface LiquidInputHandle {
    readonly element: Element;
    on<K extends keyof LiquidInputEventMap>(event: K, fn: (payload: LiquidInputEventMap[K]) => void): this;
    off<K extends keyof LiquidInputEventMap>(event: K, fn?: (payload: LiquidInputEventMap[K]) => void): this;
    once<K extends keyof LiquidInputEventMap>(event: K, fn: (payload: LiquidInputEventMap[K]) => void): this;
    value: string;
    focus(): this;
    blur(): this;
    destroy(): void;
...
export interface LiquidDialHandle {
    readonly element: Element;
    on<K extends keyof LiquidDialEventMap>(event: K, fn: (payload: LiquidDialEventMap[K]) => void): this;
    off<K extends keyof LiquidDialEventMap>(event: K, fn?: (payload: LiquidDialEventMap[K]) => void): this;
    once<K extends keyof LiquidDialEventMap>(event: K, fn: (payload: LiquidDialEventMap[K]) => void): this;
...
export interface LiquidTooltipHandle {
    readonly element: Element;
    on<K extends keyof LiquidTooltipEventMap>(event: K, fn: (payload: LiquidTooltipEventMap[K]) => void): this;
    off<K extends keyof LiquidTooltipEventMap>(event: K, fn?: (payload: LiquidTooltipEventMap[K]) => void): this;
    once<K extends keyof LiquidTooltipEventMap>(event: K, fn: (payload: LiquidTooltipEventMap[K]) => void): this;
    show(): this;
    hide(): this;
    toggle(): this;
...
export interface LiquidProgressHandle {
    readonly element: Element;
    on<K extends keyof LiquidProgressEventMap>(event: K, fn: (payload: LiquidProgressEventMap[K]) => void): this;
    off<K extends keyof LiquidProgressEventMap>(event: K, fn?: (payload: LiquidProgressEventMap[K]) => void): this;
    once<K extends keyof LiquidProgressEventMap>(event: K, fn: (payload: LiquidProgressEventMap[K]) => void): this;
