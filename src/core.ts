...
import { nextFilterId, createFilterSVG,
         injectImages, setScale,
         supportsBackdropFilter }         from './filter.js';
import type {
    LiquidGlassHandle,
    LiquidGlassEventMap,
    LiquidGlassOptions,
...
class LiquidGlassHandleImpl
    extends EventEmitter<LiquidGlassEventMap>
    implements LiquidGlassHandle
{
